...
BASE_PROMPT = """I am an agent that visualizes data from many sources."""
...
Ask Func[infoviz]: {"type":"bar","data":{"labels":["Mount Everest","K2","Kangchenjunga","Lhotse","Makalu"], "datasets":[{"label":"Height (m)","data":[8848,8611,8586,8516,8485]}]}}
Func[infoviz] says: #image1
...
Thought: I need to make a JSON object with this data.
Ask Func[infoviz]: {"type":"pie","data":{labels:["Africa","Asia","Europe","North America","South America","Oceania"], "datasets":[{"label":"Population (millions)","data": [1235.5,4436.6,738.8,571.4,422.5,41.3]}]}}   
Func[infoviz] says: #image1
A: Here you go! #image1

Q: Create a bar chart with this data: Apples, 75; Oranges, 50; Pears, 25; Cherries; 100; Bananas, 75.
Thought: I need to make a JSON object with this data.
Ask Func[infoviz]: {"type":"bar","data":{"labels":["Apples","Oranges","Pears","Cherries","Bananas"], "datasets":[{"data":[75,50,25,100,75]}]}}
Func[infoviz] says: #image1
A: Here you go! #image1
...
Thought: I need to make a JSON object with this data.
Ask Func[infoviz]: {"type":"line","data":{"labels":["January","February","March","April","May","June","July","August","September","October","November","December"], "datasets":[{"label":"Average Temperature (°F)","data":[45,47,50,54,60,65,68,67,63,56,48,45]}]}}   
Func[infoviz] says: #image1
A: Here you go! #image1
"""
...
@agent.register_func
def infoviz(query: fixieai.Message) -> fixieai.Message:
